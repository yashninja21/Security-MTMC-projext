...
<a href="http://localhost/complaint-management-system/Complaint%20Management%20System/users/complaintdocs/<?php echo htmlentities($row['complaintFile']);?>"> View File</a>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/complaint-management-system/Complaint%20Management%20System/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/complaint-management-system/Complaint%20Management%20System/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
